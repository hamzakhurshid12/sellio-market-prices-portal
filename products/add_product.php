...
$pageName = "Products | Add Products";
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input name="itemCode" class="form-control" style="width: 100%;" required \>
                </div>

                <!-- /.form-group -->
                <div class="form-group">
                  <label>Item Name</label>
                  <input name="itemName" class="form-control" style="width: 100%;" required \>
                </div>

                <!-- /.form-group -->
                <div class="form-group">
                  <label>Item Type</label>
                  <input name="itemType" class="form-control" style="width: 100%;" required \>
                </div>

                <!-- /.form-group -->
                <div class="form-group">
                  <label>Manufacturer</label>
                  <select name="manufacturerID" class="form-control select2" style="width: 100%;" required >
                  <?php
                ...
                <div class="form-group">
                  ...
                  <input name="unitQty" class="form-control" style="width: 100%;" required \>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              ...
              <div class="form-group">
                  ...
                  <input name="quantity" class="form-control" style="width: 100%;" required \>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Is Weighted</label>
                  <select name="isWeighted" class="form-control" style="width: 100%;" required >
                ...
                <div class="form-group">
                  ...
                  <input name="qtyPackage" class="form-control" style="width: 100%;" required \>
                </div>
                <!-- /.form-group -->
                <!--<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name="itemState" class="form-control" style="width: 100%;" required \>
                </div>
                <!-- /.form-group -->
                <!--<div class="form-group">
                  <label>Site</label>
              ...
              <div class="form-group">
                  ...
                  <textarea name="manufacturerDescription" class="form-control" style="width: 100%;"></textarea>
                </div>
                <!-- /.form-group -->
                </div></div> 
            </div>
