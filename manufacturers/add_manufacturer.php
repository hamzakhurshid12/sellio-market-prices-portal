            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input name="manufacturerName" class="form-control select2" style="width: 100%;" required \>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
              ...
              <div class="col-md-6">
              <div class="form-group">
                  <select name="manufacturerCountry" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                  <?php 
